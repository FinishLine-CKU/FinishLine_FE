...
function IntroPage() {
    ...
    const visitor = async () => {
        ...
        if (!lastVisit) {
            try {
                const response = await axios.post(`https://finishline-cku.com/user/set_visitor_cookie/`, {}, {
    ...
    const visitorcount = async () => {
        try {
            const response = await axios.get(`https://finishline-cku.com/user/get_visitor_info/`);
