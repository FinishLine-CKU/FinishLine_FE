...
function DoneLecturePage() {
  ...
  const SubjectSearch = async () => {
    ...
    try {
        const response = await axios.get(`http://3.35.170.181:8000/graduation/api/nowLectureData/filter-by-code/${lectureCode}/`);
  ...
  const handleSaveAllSubjects = async () => {
    try {
      ...
      const response = await fetch("http://3.35.170.181:8000/graduation/api/mydonelecture/", {
        method: "POST",
        headers: {
