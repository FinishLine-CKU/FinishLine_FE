...
export const MAJOR_ALL = [
    ...
    { value: '03300108', label: '호텔경영학과' },
    { value: '03300108', label: '트리니티융합 호텔경영학' },
    { value: '03300108', label: '트리니티자유 호텔경영학' },
    ...
    { value: '03300116', label: '트리니티융합 스마트항만공학' },  
    // { value: '', label: '다문화사회복지전공' },
    // { value: '', label: '트리니티자유 다문화사회복지전공' },
    // { value: '', label: 'K-퓨전아트전공' },
    // { value: '', label: '트리니티자유 K-퓨전아트전공' },
    // { value: '', label: '전통문화예술융합' },
    // { value: '', label: '트리니티자유 전통문화예술융합' },
    { value: '033020', label: '자율전공학부' }, 
];
// 최신학과 기준 코드
