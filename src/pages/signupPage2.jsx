...
const MAJOR = [
    ...
    { value: '030790*', label: '통합사회' }, //삭제필요요
    { value: '031103*', label: '관광경영학과' },
    { value: '031108*', label: '스포츠건강관리학과' }, //트리니티과목코드로 변경경
    { value: '031110*', label: '호텔경영학과' }, //트리니티과목코드로 변경경
    { value: '031112*', label: '스포츠레저학과' }, //트리니티과목코드로 변경경
    { value: '031163*', label: '스포츠지도학과' },
    { value: '031191*', label: '스포테인먼트전공(F)' },
    { value: '031193*', label: '조리외식경영학과' }, //트리니티티
    { value: '03120202', label: '건축학부-건축공학' }, //트리니티티
    { value: '03120203', label: '건축학부-건축학' }, //트리니티티
    ...
    { value: '032305*', label: '광고홍보학과' }, //트리니티티
    { value: '03232002', label: '경찰행정학부-경찰행정학' }, //트리니티티
    { value: '03232003', label: '경찰행정학부-해양경찰' }, //트리니티티
    ...
    { value: '032405*', label: '의료경영학과' }, //트리니티티
    ...
    { value: '032510*', label: '항공운항학과' }, //트리니티 
    { value: '032515*', label: '무인항공학과' },
    { value: '032520*', label: '항공정비학과' },
    { value: '032591*', label: '항공설계전공(F-C)' },
    { value: '03260103', label: '공연예술학부-실용음악' }, //틔니티
    { value: '03260104', label: '공연예술학부-연기예술' }, //틔니티티
    ...
    { value: '033020*', label: '자율전공학부' }, //자율전공, 트리니티자유
];
const MICRO_DEGREE = [
